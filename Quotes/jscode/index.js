 var quotes;
     ...
     function newQuote (event) {
         ...
         document.querySelector('.number').innerText = `Travel quote number # ${randomNumber}`;
         document.querySelector('.quote-text').innerText = quotes[randomNumber].quoteText;
         document.querySelector('.quote-author').innerText = quotes[randomNumber].quoteAuthor;
         }
...
quotes = [
    {
     ...
     {
        "quoteAuthor": "Tiwari Ji",
        "quoteText": "First solve the problem then code."
    },
    {
